...
import { DrawingActionKind, isCircle, isMarker, isPolygon, isPolyline, isRectangle, type Action, type DrawResult, type Overlay, type Snapshot, type State } from '../types/mapControl';
